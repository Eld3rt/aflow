...
export type GetWorkflowExecutionAggregateType<T extends WorkflowExecutionAggregateArgs> = {
    [P in keyof T & keyof AggregateWorkflowExecution]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateWorkflowExecution[P]> : Prisma.GetScalarType<T[P], AggregateWorkflowExecution[P]>;
};
...
type GetWorkflowExecutionGroupByPayload<T extends WorkflowExecutionGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<WorkflowExecutionGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof WorkflowExecutionGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], WorkflowExecutionGroupByOutputType[P]> : Prisma.GetScalarType<T[P], WorkflowExecutionGroupByOutputType[P]>;
}>>;
export type WorkflowExecutionWhereInput = {
    ...
    currentStepOrder?: Prisma.IntNullableFilter<"WorkflowExecution"> | number | null;
    context?: Prisma.JsonFilter<"WorkflowExecution">;
    pausedAt?: Prisma.DateTimeNullableFilter<"WorkflowExecution"> | Date | string | null;
    resumeAt?: Prisma.DateTimeNullableFilter<"WorkflowExecution"> | Date | string | null;
...
export type WorkflowExecutionScalarWhereWithAggregatesInput = {
    ...
    currentStepOrder?: Prisma.IntNullableWithAggregatesFilter<"WorkflowExecution"> | number | null;
    context?: Prisma.JsonWithAggregatesFilter<"WorkflowExecution">;
    pausedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"WorkflowExecution"> | Date | string | null;
    resumeAt?: Prisma.DateTimeNullableWithAggregatesFilter<"WorkflowExecution"> | Date | string | null;
...
export type WorkflowExecutionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<WorkflowExecutionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface WorkflowExecutionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends WorkflowExecutionCountArgs>(args?: Prisma.Subset<T, WorkflowExecutionCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], WorkflowExecutionCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends WorkflowExecutionGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, WorkflowExecutionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetWorkflowExecutionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface WorkflowExecutionFieldRefs {
    ...
    readonly currentStepOrder: Prisma.FieldRef<"WorkflowExecution", 'Int'>;
    readonly context: Prisma.FieldRef<"WorkflowExecution", 'Json'>;
    readonly pausedAt: Prisma.FieldRef<"WorkflowExecution", 'DateTime'>;
    readonly resumeAt: Prisma.FieldRef<"WorkflowExecution", 'DateTime'>;
