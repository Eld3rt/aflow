...
export type TriggerWhereInput = {
    ...
    config?: Prisma.JsonFilter<"Trigger">;
...
export type TriggerScalarWhereWithAggregatesInput = {
    ...
    config?: Prisma.JsonWithAggregatesFilter<"Trigger">;
...
export type TriggerOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "type" | "config" | "workflowId" | "createdAt", ExtArgs["result"]["trigger"]>;
...
export interface TriggerFieldRefs {
    ...
    readonly config: Prisma.FieldRef<"Trigger", 'Json'>;
